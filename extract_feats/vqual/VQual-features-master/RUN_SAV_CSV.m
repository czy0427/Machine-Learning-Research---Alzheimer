% ================================================================
%   Feature Extraction to CSV Files
% ================================================================
...
IS_WB        = false;    % if true, Fs=16000, else, Fs=8000
...
dataRoot = '/Users/suzinia/tmp/speech_samples/';    gender='f';
saveRoot = '/Users/suzinia/tmp/speech_samples/';
dirPraat = '/Users/suzinia/GitRepo/VoiceSauce/Praat/';
...
for n = 1:length(dirData)        
    ...
    for i=1:length(dataList)
        ...
        if strcmp(ext, '.wav')
            ...
            outFilePath = [currDirSave savFolder filename '.csv'];
            
            extract_features_csv( sndFilePath, outFilePath, config, dirPraat);
